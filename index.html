 ...
 <div data-role="page" id="leaderboard">
  <div data-role="header" data-position="fixed">
    ...
    <?php
   	...
   	$updatedtime = "<span>" .date('d-m-Y') .", " .date('h:i a') ."</span>";
    ?>
...
<script>
	...
	$("#leaderboard").on('pageinit', pullLeaderboard);
        ...
        $("#resultLog").html("<h3>Getting latest ATC Leaderboard. Please wait ...</h3>");
                ...
                $.ajax({
                  type: "GET",
                  url: "http://atcapp.superkidschess.com/android/getLeaderboard.php",
                  cache: false,
                  dataType: "json",
                  success: onSuccess
                });
	...
	//console.log('fresh Get: ', data.result);
        ...
        $('#matches').append('<li data-role="list-divider">ATC Leaderboard <span class="ui-li-count"><?php echo $updatedtime; ?></span></li>');    
